...
-- entradas[4]	=>  Location: PIN_25,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \fsm|current_state.EntryMode~feeder_combout\ : std_logic;
...
SIGNAL \fsm|current_state.Write19~feeder_combout\ : std_logic;
...
SIGNAL \fsm|current_state.Write23~feeder_combout\ : std_logic;
...
SIGNAL \fsm|current_state.Write30~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \fsm|Equal0~0_combout\ = (!\fsm|Add0~6_combout\ & (!\fsm|Add0~0_combout\ & (!\fsm|Add0~2_combout\ & !\fsm|Add0~4_combout\)))
...
-- Equation(s):
-- \fsm|Selector0~0_combout\ = (\entradas[2]~input_o\ & ((\entradas[3]~input_o\) # ((\entradas[4]~input_o\) # (\entradas[1]~input_o\)))) # (!\entradas[2]~input_o\ & ((\entradas[3]~input_o\ & ((\entradas[4]~input_o\) # (\entradas[1]~input_o\))) # 
-- (!\entradas[3]~input_o\ & (\entradas[4]~input_o\ $ (!\entradas[1]~input_o\)))))
...
-- Equation(s):
-- \fsm|Selector0~1_combout\ = (\entradas[3]~input_o\) # ((\entradas[2]~input_o\) # (\entradas[1]~input_o\))
...
-- Equation(s):
-- \fsm|Selector0~2_combout\ = (\fsm|current_state.ClearDisplay2~q\ & ((\entradas[0]~input_o\ & ((\fsm|Selector0~1_combout\) # (!\fsm|Selector0~0_combout\))) # (!\entradas[0]~input_o\ & (\fsm|Selector0~0_combout\))))
...
\fsm|current_state.EntryMode~feeder\ : cycloneive_lcell_comb
-- Equation(s):
...
-- Equation(s):
-- \fsm|Selector8~0_combout\ = (\entradas[4]~input_o\ & (!\entradas[1]~input_o\ & (!\entradas[2]~input_o\ & !\entradas[0]~input_o\)))
...
-- Equation(s):
-- \fsm|Selector6~0_combout\ = (!\entradas[4]~input_o\ & (!\entradas[0]~input_o\ & (!\entradas[3]~input_o\ & \fsm|current_state.ClearDisplay2~q\)))
...
-- pragma translate_on
PORT MAP (
	datad => \fsm|current_state.Write15~q\,
...
\fsm|current_state.Write19~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|current_state.Write19~feeder_combout\ = \fsm|current_state.Write18~q\
...
PORT MAP (
	...
	combout => \fsm|current_state.Write19~feeder_combout\);
...
PORT MAP (
	clk => \fsm|e~clkctrl_outclk\,
	d => \fsm|current_state.Write19~feeder_combout\,
	clrn => \reset_low~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\fsm|current_state.Write23~feeder\ : cycloneive_lcell_comb
-- Equation(s):
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|current_state.Write23~q\,
...
-- Equation(s):
-- \fsm|next_state.ClearDisplay4~0_combout\ = (\cont|bus_out~q\ & (\fsm|current_state.ReturnHome2~q\ & \fsm|nx_proc:flag~combout\))
...
-- Equation(s):
-- \fsm|Selector6~1_combout\ = (\fsm|current_state.ClearDisplay4~q\) # ((\entradas[2]~input_o\ & (!\entradas[1]~input_o\ & \fsm|Selector6~0_combout\)))
...
\fsm|current_state.Write30~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|current_state.Write30~feeder_combout\ = \fsm|current_state.Write29~q\
...
PORT MAP (
	...
	combout => \fsm|current_state.Write30~feeder_combout\);
...
PORT MAP (
	clk => \fsm|e~clkctrl_outclk\,
	d => \fsm|current_state.Write30~feeder_combout\,
	clrn => \reset_low~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \fsm|WideOr18~0_combout\ = (!\fsm|current_state.ReturnHome3~q\ & (!\fsm|current_state.ReturnHome2~q\ & (!\fsm|current_state.ReturnHome1~q\ & !\fsm|current_state.ReturnHome4~q\)))
...
-- Equation(s):
-- \cont|Equal0~5_combout\ = (!\cont|cont\(7) & (\cont|cont\(8) & (!\cont|cont\(9) & !\cont|cont\(10))))
...
-- Equation(s):
-- \cont|cont~2_combout\ = (\cont|Add0~46_combout\ & !\cont|Equal0~8_combout\)
...
-- Equation(s):
-- \cont|Add0~52_combout\ = \cont|cont\(26) $ (!\cont|Add0~51\)
...
-- Equation(s):
-- \cont|Equal0~2_combout\ = (!\cont|cont\(17) & (\cont|cont\(18) & (\cont|cont\(15) & \cont|cont\(16))))
...
-- Equation(s):
-- \cont|Equal0~1_combout\ = (!\cont|cont\(19) & (\cont|cont\(20) & (\cont|cont\(22) & \cont|cont\(21))))
...
-- Equation(s):
-- \cont|Equal0~3_combout\ = (!\cont|cont\(11) & (\cont|cont\(13) & (\cont|cont\(14) & !\cont|cont\(12))))
...
-- Equation(s):
-- \cont|Equal0~8_combout\ = (\cont|Equal0~5_combout\ & (\cont|Equal0~7_combout\ & (\cont|Equal0~6_combout\ & \cont|Equal0~4_combout\)))
...
-- Equation(s):
-- \fsm|Selector7~0_combout\ = (!\entradas[2]~input_o\ & (\entradas[3]~input_o\ & (!\entradas[0]~input_o\ & !\entradas[1]~input_o\)))
...
-- Equation(s):
-- \fsm|next_state.Write1~0_combout\ = (\fsm|current_state.ClearDisplay2~q\ & (!\entradas[3]~input_o\ & \fsm|Mux1~0_combout\))
...
PORT MAP (
	clk => \fsm|e~clkctrl_outclk\,
	asdata => \fsm|current_state.Write4~q\,
	clrn => \reset_low~inputclkctrl_outclk\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \fsm|WideOr10~0_combout\ = (\fsm|WideOr16~1_combout\ & (\fsm|WideOr18~0_combout\ & (!\fsm|current_state.DisplayControl~q\ & !\fsm|current_state.EntryMode~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|WideOr16~1_combout\,
	datab => \fsm|WideOr18~0_combout\,
...
-- Equation(s):
-- \fsm|WideOr10~1_combout\ = (\fsm|current_state.FunctionSet1~q\ & (!\fsm|current_state.FunctionSet3~q\ & (!\fsm|current_state.FunctionSet4~q\ & !\fsm|current_state.FunctionSet2~q\)))
...
-- Equation(s):
-- \fsm|WideOr16~4_combout\ = (\fsm|current_state.Write30~q\) # ((\fsm|WideOr16~3_combout\) # ((\fsm|current_state.Write37~q\) # (!\fsm|WideOr16~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|current_state.Write30~q\,
...
-- Equation(s):
-- \fsm|WideOr13~0_combout\ = (!\fsm|current_state.Write8~q\ & (!\fsm|current_state.Write4~q\ & (!\fsm|current_state.Write15~q\ & !\fsm|current_state.Write11~q\)))
...
-- Equation(s):
-- \fsm|WideOr13~1_combout\ = (!\fsm|current_state.Write27~q\ & (\fsm|WideOr13~0_combout\ & (!\fsm|current_state.Write33~q\ & !\fsm|current_state.Write23~q\)))
...
-- Equation(s):
-- \fsm|WideOr15~0_combout\ = (!\fsm|current_state.Write14~q\ & (!\fsm|current_state.Write24~q\ & (!\fsm|current_state.Write36~q\ & \fsm|WideOr13~1_combout\)))
...
-- Equation(s):
-- \fsm|WideOr16~2_combout\ = (\fsm|current_state.Write26~q\) # ((\fsm|current_state.Write16~q\) # ((\fsm|current_state.Write25~q\) # (\fsm|current_state.Write10~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|WideOr16~4_combout\,
	datac => \fsm|WideOr15~0_combout\,
...
-- Equation(s):
-- \fsm|WideOr15~2_combout\ = (\fsm|current_state.EntryMode~q\) # ((\fsm|current_state.Write9~q\) # ((\fsm|current_state.Write5~q\) # (\fsm|current_state.Write34~q\)))
...
PORT MAP (
	...
	datac => \fsm|current_state.Write5~q\,
...
-- Equation(s):
-- \fsm|WideOr15~1_combout\ = (\fsm|current_state.Write3~q\) # ((\fsm|current_state.Write31~q\) # (\fsm|current_state.Write28~q\))
...
-- Equation(s):
-- \fsm|WideOr12~1_combout\ = (\fsm|current_state.Write35~q\) # ((\fsm|current_state.Write24~q\) # ((\fsm|current_state.Write17~q\) # (\fsm|current_state.Write29~q\)))
...
-- Equation(s):
-- \fsm|WideOr11~1_combout\ = (\fsm|current_state.Write34~q\) # ((\fsm|current_state.Write37~q\) # ((\fsm|current_state.Write36~q\) # (\fsm|current_state.Write14~q\)))
...
PORT MAP (
	...
	datab => \fsm|current_state.Write37~q\,
	datac => \fsm|current_state.Write36~q\,
	datad => \fsm|current_state.Write14~q\,
	combout => \fsm|WideOr11~1_combout\);

-- Location: LCCOMB_X18_Y15_N4
\fsm|WideOr11~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|WideOr11~0_combout\ = (\fsm|current_state.Write1~q\) # ((\fsm|current_state.Write24~q\) # ((\fsm|current_state.Write35~q\) # (\fsm|current_state.Write29~q\)))
...
-- Equation(s):
-- \fsm|WideOr10~combout\ = ((\fsm|current_state.Write13~q\) # ((\fsm|current_state.Write12~q\) # (!\fsm|WideOr10~1_combout\))) # (!\fsm|WideOr10~0_combout\)
