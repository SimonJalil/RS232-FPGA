...
SIGNAL \cont|cont[17]~feeder_combout\ : std_logic;
...
SIGNAL \cont|cont[19]~feeder_combout\ : std_logic;
...
SIGNAL \fsm|current_state.SetAddress~feeder_combout\ : std_logic;
...
SIGNAL \fsm|WideOr12~2_combout\ : std_logic;
SIGNAL \fsm|WideOr12~3_combout\ : std_logic;
...
-- Equation(s):
-- \fsm|Equal0~3_combout\ = (\fsm|Add0~20_combout\ & (!\fsm|Add0~22_combout\ & (!\fsm|Add0~24_combout\ & \fsm|Equal0~2_combout\)))
...
-- Equation(s):
-- \fsm|Add0~32_combout\ = \fsm|clock:cont[16]~q\ $ (!\fsm|Add0~31\)
...
-- Equation(s):
-- \cont|Equal0~5_combout\ = (\cont|cont\(8) & (!\cont|cont\(7) & (!\cont|cont\(9) & !\cont|cont\(10))))
...
-- Equation(s):
-- \cont|Equal0~7_combout\ = (!\cont|cont\(0) & (!\cont|cont\(1) & !\cont|cont\(2)))
...
-- Equation(s):
-- \cont|cont~9_combout\ = (\cont|Add0~28_combout\ & !\cont|Equal0~8_combout\)
...
\cont|cont[17]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \cont|cont[17]~feeder_combout\ = \cont|Add0~34_combout\
...
PORT MAP (
	...
	combout => \cont|cont[17]~feeder_combout\);
...
-- Equation(s):
-- \cont|cont~6_combout\ = (\cont|Add0~36_combout\ & !\cont|Equal0~8_combout\)
...
\cont|cont[19]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \cont|cont[19]~feeder_combout\ = \cont|Add0~38_combout\
...
PORT MAP (
	...
	combout => \cont|cont[19]~feeder_combout\);
...
-- Equation(s):
-- \cont|cont~1_combout\ = (\cont|Add0~48_combout\ & !\cont|Equal0~8_combout\)
...
-- Equation(s):
-- \cont|Equal0~0_combout\ = (\cont|cont\(23) & (\cont|cont\(24) & (\cont|cont\(26) & !\cont|cont\(25))))
...
-- Equation(s):
-- \cont|Equal0~2_combout\ = (\cont|cont\(15) & (\cont|cont\(18) & (!\cont|cont\(17) & \cont|cont\(16))))
...
-- Equation(s):
-- \cont|Equal0~3_combout\ = (!\cont|cont\(12) & (!\cont|cont\(11) & (\cont|cont\(14) & \cont|cont\(13))))
...
-- Equation(s):
-- \cont|Equal0~8_combout\ = (\cont|Equal0~5_combout\ & (\cont|Equal0~6_combout\ & (\cont|Equal0~7_combout\ & \cont|Equal0~4_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \cont|Equal0~5_combout\,
	datab => \cont|Equal0~6_combout\,
...
-- Equation(s):
-- \fsm|Selector0~1_combout\ = (\entradas[1]~input_o\) # ((\entradas[3]~input_o\) # (\entradas[2]~input_o\))
...
-- Equation(s):
-- \fsm|Selector0~0_combout\ = (\entradas[2]~input_o\ & ((\entradas[3]~input_o\) # ((\entradas[1]~input_o\) # (\entradas[4]~input_o\)))) # (!\entradas[2]~input_o\ & ((\entradas[3]~input_o\ & ((\entradas[1]~input_o\) # (\entradas[4]~input_o\))) # 
-- (!\entradas[3]~input_o\ & (\entradas[1]~input_o\ $ (!\entradas[4]~input_o\)))))
...
-- Equation(s):
-- \fsm|Selector9~0_combout\ = (\fsm|current_state.ReturnHome4~q\) # ((\entradas[1]~input_o\) # (\entradas[0]~input_o\))
...
-- Equation(s):
-- \fsm|Selector8~1_combout\ = (\fsm|current_state.ReturnHome4~q\) # ((!\entradas[3]~input_o\ & (\fsm|Selector8~0_combout\ & \fsm|current_state.ClearDisplay2~q\)))
...
-- Equation(s):
-- \fsm|Selector6~1_combout\ = (\fsm|current_state.ClearDisplay4~q\) # ((\entradas[2]~input_o\ & (\fsm|Selector6~0_combout\ & !\entradas[1]~input_o\)))
...
PORT MAP (
	...
	datac => \fsm|current_state.ClearDisplay4~q\,
...
-- Equation(s):
-- \fsm|Selector7~1_combout\ = (\fsm|current_state.ClearDisplay5~q\) # ((!\entradas[4]~input_o\ & (\fsm|Selector7~0_combout\ & \fsm|current_state.ClearDisplay2~q\)))
...
\fsm|current_state.SetAddress~feeder\ : cycloneive_lcell_comb
-- Equation(s):
...
\fsm|current_state.Write16~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|current_state.Write16~feeder_combout\ = \fsm|current_state.Write15~q\
...
PORT MAP (
	...
	combout => \fsm|current_state.Write16~feeder_combout\);
...
PORT MAP (
	clk => \fsm|e~clkctrl_outclk\,
	d => \fsm|current_state.Write16~feeder_combout\,
	clrn => \reset_low~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\fsm|current_state.Write18~feeder\ : cycloneive_lcell_comb
-- Equation(s):
...
\fsm|current_state.Write20~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|current_state.Write20~feeder_combout\ = \fsm|current_state.Write19~q\
...
-- pragma translate_on
PORT MAP (
	datac => \fsm|current_state.Write19~q\,
	combout => \fsm|current_state.Write20~feeder_combout\);
...
PORT MAP (
	clk => \fsm|e~clkctrl_outclk\,
	d => \fsm|current_state.Write20~feeder_combout\,
	clrn => \reset_low~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \fsm|Selector0~3_combout\ = (!\fsm|nx_proc:flag~combout\ & ((\fsm|current_state.ReturnHome2~q\) # ((\fsm|current_state.ReturnHome1~q\) # (\fsm|current_state.ReturnHome3~q\))))
...
-- Equation(s):
-- \fsm|Selector6~0_combout\ = (!\entradas[3]~input_o\ & (!\entradas[4]~input_o\ & (\fsm|current_state.ClearDisplay2~q\ & !\entradas[0]~input_o\)))
...
-- Equation(s):
-- \fsm|Selector5~0_combout\ = (\fsm|current_state.ClearDisplay3~q\) # ((!\entradas[2]~input_o\ & (\fsm|Selector6~0_combout\ & \entradas[1]~input_o\)))
...
-- Equation(s):
-- \fsm|WideOr18~0_combout\ = (!\fsm|current_state.ReturnHome2~q\ & (!\fsm|current_state.ReturnHome4~q\ & (!\fsm|current_state.ReturnHome1~q\ & !\fsm|current_state.ReturnHome3~q\)))
...
-- Equation(s):
-- \fsm|WideOr16~2_combout\ = (\fsm|current_state.Write16~q\) # ((\fsm|current_state.Write26~q\) # ((\fsm|current_state.Write10~q\) # (\fsm|current_state.Write25~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|current_state.Write16~q\,
	datab => \fsm|current_state.Write26~q\,
	datac => \fsm|current_state.Write10~q\,
	datad => \fsm|current_state.Write25~q\,
...
-- Equation(s):
-- \fsm|WideOr16~3_combout\ = (\fsm|current_state.Write6~q\) # ((\fsm|current_state.Write2~q\) # ((\fsm|current_state.Write21~q\) # (\fsm|current_state.Write19~q\)))
...
PORT MAP (
	...
	datab => \fsm|current_state.Write2~q\,
	datac => \fsm|current_state.Write21~q\,
	datad => \fsm|current_state.Write19~q\,
	combout => \fsm|WideOr16~3_combout\);

-- Location: LCCOMB_X24_Y15_N30
\fsm|WideOr16~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|WideOr16~4_combout\ = (\fsm|WideOr16~3_combout\) # ((\fsm|current_state.Write36~q\) # ((\fsm|current_state.Write30~q\) # (\fsm|current_state.Write37~q\)))
...
-- Equation(s):
-- \fsm|WideOr13~1_combout\ = (!\fsm|current_state.Write27~q\ & (!\fsm|current_state.Write23~q\ & (!\fsm|current_state.Write33~q\ & \fsm|WideOr13~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|current_state.Write27~q\,
...
-- Equation(s):
-- \fsm|WideOr15~0_combout\ = (!\fsm|current_state.Write14~q\ & (!\fsm|current_state.Write24~q\ & \fsm|WideOr13~1_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|current_state.Write14~q\,
...
-- Equation(s):
-- \fsm|WideOr16~combout\ = (\fsm|WideOr16~2_combout\) # (((\fsm|WideOr16~4_combout\) # (!\fsm|WideOr15~0_combout\)) # (!\fsm|WideOr16~1_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|WideOr16~2_combout\,
	datab => \fsm|WideOr16~1_combout\,
	datac => \fsm|WideOr16~4_combout\,
	datad => \fsm|WideOr15~0_combout\,
	combout => \fsm|WideOr16~combout\);

-- Location: LCCOMB_X24_Y15_N18
\fsm|WideOr15~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|WideOr15~2_combout\ = (\fsm|current_state.EntryMode~q\) # ((\fsm|current_state.Write34~q\) # ((\fsm|current_state.Write3~q\) # (\fsm|current_state.Write36~q\)))
...
-- Equation(s):
-- \fsm|WideOr15~1_combout\ = (\fsm|current_state.Write9~q\) # ((\fsm|current_state.Write5~q\) # ((\fsm|current_state.Write31~q\) # (\fsm|current_state.Write28~q\)))
...
-- Equation(s):
-- \fsm|WideOr15~combout\ = (\fsm|WideOr15~2_combout\) # ((\fsm|WideOr15~1_combout\) # (!\fsm|WideOr15~0_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|WideOr15~2_combout\,
	datab => \fsm|WideOr15~0_combout\,
	datad => \fsm|WideOr15~1_combout\,
	combout => \fsm|WideOr15~combout\);

-- Location: LCCOMB_X24_Y15_N12
\fsm|WideOr13~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|WideOr13~2_combout\ = (!\fsm|current_state.DisplayControl~q\ & (!\fsm|current_state.Write16~q\ & (!\fsm|current_state.Write26~q\ & !\fsm|current_state.Write1~q\)))
...
-- Equation(s):
-- \fsm|WideOr13~3_combout\ = (!\fsm|current_state.Write18~q\ & (!\fsm|current_state.Write32~q\ & !\fsm|current_state.Write28~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|current_state.Write18~q\,
...
-- Equation(s):
-- \fsm|WideOr12~0_combout\ = (!\fsm|current_state.Write20~q\ & (!\fsm|current_state.Write7~q\ & !\fsm|current_state.Write13~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \fsm|current_state.Write20~q\,
...
-- Equation(s):
-- \fsm|WideOr14~0_combout\ = (\fsm|current_state.EntryMode~q\) # ((\fsm|current_state.Write34~q\) # ((\fsm|current_state.Write36~q\) # (\fsm|current_state.Write19~q\)))
...
\fsm|WideOr14\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|WideOr14~combout\ = (((\fsm|current_state.Write22~q\) # (\fsm|WideOr14~0_combout\)) # (!\fsm|WideOr12~0_combout\)) # (!\fsm|WideOr13~4_combout\)
...
-- Equation(s):
-- \fsm|WideOr13~combout\ = ((\fsm|current_state.Write10~q\) # ((\fsm|current_state.Write25~q\) # (!\fsm|WideOr10~1_combout\))) # (!\fsm|WideOr13~4_combout\)
...
-- Equation(s):
-- \fsm|WideOr12~1_combout\ = (\fsm|current_state.Write29~q\) # ((\fsm|current_state.Write35~q\) # ((\fsm|current_state.Write17~q\) # (\fsm|current_state.Write24~q\)))
...
PORT MAP (
	...
	datab => \fsm|current_state.Write35~q\,
	datac => \fsm|current_state.Write17~q\,
	datad => \fsm|current_state.Write24~q\,
	combout => \fsm|WideOr12~1_combout\);

-- Location: LCCOMB_X23_Y15_N30
\fsm|WideOr12~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|WideOr12~2_combout\ = (!\fsm|current_state.Write9~q\ & !\fsm|current_state.Write5~q\)
...
PORT MAP (
	dataa => \fsm|current_state.Write9~q\,
	datab => \fsm|current_state.Write5~q\,
	combout => \fsm|WideOr12~2_combout\);

-- Location: LCCOMB_X23_Y15_N0
\fsm|WideOr12~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \fsm|WideOr12~3_combout\ = ((\fsm|WideOr12~1_combout\) # ((!\fsm|WideOr12~0_combout\) # (!\fsm|WideOr12~2_combout\))) # (!\fsm|WideOr10~1_combout\)
...
PORT MAP (
	...
	datac => \fsm|WideOr12~2_combout\,
	datad => \fsm|WideOr12~0_combout\,
	combout => \fsm|WideOr12~3_combout\);
...
-- Equation(s):
-- \fsm|WideOr11~1_combout\ = (\fsm|current_state.Write36~q\) # ((\fsm|current_state.Write34~q\) # ((\fsm|current_state.Write14~q\) # (\fsm|current_state.Write37~q\)))
...
-- Equation(s):
-- \fsm|WideOr11~combout\ = (\fsm|WideOr11~0_combout\) # ((\fsm|WideOr11~1_combout\) # ((\fsm|current_state.SetAddress~q\) # (!\fsm|WideOr10~0_combout\)))
...
-- Equation(s):
-- \fsm|WideOr10~combout\ = (((\fsm|current_state.Write12~q\) # (\fsm|current_state.Write13~q\)) # (!\fsm|WideOr10~0_combout\)) # (!\fsm|WideOr10~1_combout\)
